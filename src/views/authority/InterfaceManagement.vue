        ...
        <el-form :inline="true" size="small">
          ...
          <el-form-item label="所属系统">
            <el-select v-model="tableForm.subsystemCode" @change="search">
              ...
              <el-option v-for="(li, i) in sysOptions" :key="i" :value="li.code" :label="li.subsystemName"></el-option>
            </el-select>
          </el-form-item>
    ...
    <div class="dialog-body" v-else>
      <el-form :model="addForm" :rules="addRules" size="small" label-width="150px" ref="addForm" v-loading="addLoading">
        ...
        <el-form-item label="接口：" prop="uri">
          <el-input v-model="addForm.uri" :maxlength="200" clearable class="inpW"></el-input>
        </el-form-item>
...
export default class InterfaceManagement extends Vue {
  ...
  addRules = {
    ...
    uri: { required: true, trigger: "blur", message: "请输入接口" },
    subsystemCode: {
      required: true,
      trigger: "blur",
      message: "请选择所属系统"
  ...
  handleAddSubmit() {
    ...
    rest.validate((valid: any) => {
      if (valid) {
        ...
        let url = this.addForm.id ? Url.auth.editInterface : Url.auth.addInterface;
